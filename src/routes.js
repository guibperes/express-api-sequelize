...
// Book
routes.post('/books', Validations.validateBody(BookCreateValidator), BookController.create)
...
routes.put('/books/:id', Validations.validateId, Validations.validateBody(BookUpdateValidator), BookController.updateById)
